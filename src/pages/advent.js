  ...
  return (
    <Layout>
      ...
      <ol>
        ...
        <li>
          <Link to="/advent/2020/16">Day Sixteen</Link>
        </li>
        <li>
          <Link to="/advent/2020/17">Day Seventeen</Link>
        </li>
        <li>
          <Link >Day Eighteen</Link>
        </li>
        <li>
          <Link to="/advent/2020/19">Day Nineteen</Link>
        </li>
        <li>
          <Link to="/advent/2020/25">Day Twenty-Five</Link>
        </li>
      </ol>
